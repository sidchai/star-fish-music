package com.sidchai.music.result;
...
public enum ResultCodeEnum {
    ...
    TOKEN_ERROR(false,23006, "token过期"),
    ...
    LOGIN_MESSAGE_ERROR(false, 28009, "没有查到您相关信息,请先去注册"),
    LOGIN_FREEZE_ERROR(false, 28009, "该账户登录错误次数过多，已冻结"),
    LOGIN_USERNAME_ERROR(false, 28001, "账号或邮箱或手机不正确"),
    LOGIN_PASSWORD_ERROR(false, 28008, "密码不正确"),
    LOGIN_DISABLED_ERROR(false, 28002, "该用户已被禁用"),
    REGISTER_MOBLE_ERROR(false, 28003, "手机号已被注册"),
    REGISTER_USERNAME_ERROR(false, 28003, "用户名已被注册"),
    SONG_EXIST(false, 28009, "该歌曲已添加"),
